...
[Cronograma]: <./ip_cronograma.pdf> "Cronograma"
...
[Inscrição Prova Suficiência]: <https://forms.office.com/r/dVtdMzKAUV> "Inscrição Prova Suficiência"

# Disciplina de Introdução à Programação - BCC
...
Para se localizar em relação aos dias de aula e o conteúdo que está sendo passado utilize o arquivo [ip_cronograma.pdf](ip_cronograma.pdf) que se encontra na pasta raiz deste GitHub.
...
**IMPORTANTE**: sempre consulte o [Cronograma](ip_cronograma.pdf "Cronograma") para verificar os prazos de entrega das atividades avaliativas.
